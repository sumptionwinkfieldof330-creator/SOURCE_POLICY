...
export const cs: AppStrings = {
  ...
  info: {
    ...
    appealContentOptions: [
      ...
      { id: 'exploitation_abuse_harassment', label: 'Vykořisťování, zneužívání a obtěžování' },
      { id: 'hate_speech', label: 'Nenávistné projevy' },
      { id: 'violent_graphic_content', label: 'Násilný a grafický obsah' },
