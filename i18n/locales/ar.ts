...
export const ar: AppStrings = {
  ...
  info: {
    ...
    appealContentOptions: [
      ...
      { id: 'exploitation_abuse_harassment', label: 'الاستغلال والإساءة والمضايقة' },
      { id: 'hate_speech', label: 'خطاب الكراهية' },
      { id: 'violent_graphic_content', label: 'المحتوى العنيف والصريح' },
