...
export const ko: AppStrings = {
  ...
  main: {
    ...
    feature1Title: '계정 보호',
    feature1Desc:
      'Meta Verified는 페이지 및 연결된 관리자 계정에 고급 보호 기능을 제공하여 비정상적인 접근 활동을 조기에 감지합니다. Meta 보안 기준에 따른 지속적인 모니터링으로 계정 탈취 및 오용 위험을 줄입니다. 신원 확인 절차를 통해 승인된 사용자만 페이지의 중요한 변경을 수행할 수 있습니다.',
    feature2Title: '인증 배지',
    feature2Desc:
      'Meta Verified 파란 배지는 공식 인증 절차를 완료한 페이지에 부여되어, 오디언스가 신뢰할 수 있는 정보 출처를 즉시 식별할 수 있게 합니다. 배지는 Facebook 및 관련 Meta 플랫폼에서 일관되게 표시되어 브랜드 커뮤니케이션의 투명성을 높입니다. 이 인증 기준은 Meta가 관리하며, 공식 페이지와 사칭 또는 미인증 계정을 명확히 구분합니다.',
    feature3Title: '우선 지원',
    feature3Desc:
      'Meta Verified 회원은 비즈니스 전용 지원 채널에 우선적으로 접근하여 페이지 또는 광고 계정 문제에 대한 응답 시간을 단축할 수 있습니다. 전담 팀이 Meta 표준 절차에 따라 인증, 보안 및 정책 준수 관련 요청을 처리합니다. 모든 지원은 공식 티켓 시스템을 통해 기록되고 추적됩니다.',
    feature4Title: '신뢰도 향상',
    feature4Desc:
      'Meta Verified 상태는 Meta가 귀하의 페이지를 조직 또는 브랜드의 공식 대표로 확인했음을 나타냅니다. 이는 거래, 파트너십 및 고객·파트너와의 커뮤니케이션에서 신뢰성을 강화합니다. 신뢰는 신원의 투명성에 기반하며, 온라인 비즈니스 활동을 위한 견고한 토대를 마련합니다.',
    feature5Title: '오디언스 성장',
    feature5Desc:
      '활성화 후 페이지는 Meta 정책에 부합하는 표시 조건에서 우선적으로 노출되어 적절한 타깃 오디언스에 도달할 수 있습니다. 인증 배지의 진정성은 참여율 향상과 장기적인 팔로워 유지에 기여합니다. 기업은 인증된 신뢰성을 활용하여 커뮤니티를 지속 가능하고 통제된 방식으로 성장시킬 수 있습니다.',
    feature6Title: '수익화 기회',
    feature6Desc:
      'Meta Verified는 Meta가 자격을 갖춘 페이지에 제공하는 수익화 프로그램 및 성장 도구에 대한 접근을 제공합니다. 정책 준수 절차는 명확하게 설계되어 기업이 콘텐츠와 참여를 통해 투명하게 수익을 창출할 수 있도록 돕습니다. 모든 수익화 기능은 인증 기준 및 플랫폼 브랜드 보호와 연계됩니다.',
