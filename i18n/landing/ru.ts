...
export const ruLanding: LandingStrings = {
  ...
  steps: {
    ...
    subtitle: 'Перед отправкой сравните помеченный контент с Правила сообщества в Transparency Center. Примерное время заполнения формы: примерно 5–10 минут.',
    items: [
      {
  ...
  finalCta: {
    ...
    subtitle: 'Если после прочтения Правила сообщества вы считаете, что ваша Страница соответствует политике, отправьте форму, указав данные администратора и подтвердив личность.',
    cta: 'Подать апелляцию',
  },
  faq: {
